...
本 Mod 的目标是改善多人游戏中途掉线后的恢复体验。它不是实时同步回滚系统，而是围绕“楼层入口检查点”工作：房主在每个有效地牢楼层入口保存检查点，成员掉线后保留 SteamID 与玩家槽位，随后通过 Steam 邀请、上次房间数据和 Mod 握手尽量让成员回到原槽位，再由房主执行本层恢复。
...
Release 压缩包里的顶层文件夹通常带版本号，例如 `SephiriaReconnect-v0.1.8`。安装时可以：
...
6. 房主可以先点“本层恢复”，也可以先点“邀请重连”。
7. 房主点“邀请重连”后，Steam 邀请窗口会打开，并会尝试自动邀请历史掉线成员。
8. 成员通过 Steam 邀请或“加入上次房间”回到房主会话。
9. 安装了 Mod 的成员会自动握手，或手动点击“发送握手”。
10. 房主确认成员已回房后，可以再次执行“本层恢复”，让所有人回到本层入口检查点状态。
